...
Declaración de adopción AOS para `anclora-groundsync`.

## Metadatos

- Repository Name: anclora-groundsync
...
`anclora-groundsync` forma parte del ecosistema Anclora como aplicación operativa Vite + React.
